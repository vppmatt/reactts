...
export const getAllPaymentsFetchVersion : () => Promise<Response> = () => {
    ...
    const transactionsPromise : Promise<Response> = fetch("http://localhost:8080/api/payment", {
        method: "GET",
...
export const getAllPaymentsAxiosVersion : () => AxiosPromise<PaymentType[]>  = () => {
    console.log("fetching data using axios");
    const transactionsPromise = axios({url : "http://localhost:8080/api/payment",
